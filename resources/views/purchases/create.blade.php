...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    {{-- 🔹 Alerts --}}
    @if ($errors->any())
        <div class="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 text-red-700 dark:text-red-300 p-4 rounded-lg mb-4">
    ...
    @if (session('success'))
        <div class="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 text-green-700 dark:text-green-300 p-4 rounded-lg mb-4">
            {{ session('success') }}
        </div>
    @endif
    ...
    <form action="{{ route('purchases.store') }}" method="POST"
          class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm rounded-xl p-6 space-y-8">
        @csrf
        ...
        <div>
            ...
            <div id="product-rows" class="space-y-2">
                <div class="flex flex-wrap gap-2 bg-gray-50 dark:bg-gray-900/40 p-3 rounded-lg">
                    ...
                    <input type="number" step="0.01" name="products[0][unit_cost]"
                    ...
                    <input type="text"
                           class="total-field w-32 border-gray-300 dark:border-gray-700 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-center"
                           value="0.00" readonly>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-900/40 border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex justify-between items-center">
            ...
            <span id="total-display" class="text-2xl font-bold text-green-700 dark:text-green-400">0.00</span>
        ...
        const newRow = `
            <div class="flex flex-wrap gap-2 bg-gray-50 dark:bg-gray-900/40 p-3 rounded-lg mt-2">
                ...
                <input type="number" name="products[${rowCount}][quantity]"
                       class="qty-field w-24 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 rounded-lg focus:ring-indigo-500 focus:border-indigo-500" placeholder="Qty" min="1" required>
                ...
                <input type="text" class="total-field w-32 border-gray-300 dark:border-gray-700 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-center" value="0.00" readonly>
            </div>`;
