        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
            ...
            <div class="bg-white shadow rounded-lg p-4 space-y-3">
                ...
                <div class="flex justify-between text-sm items-center">
                    <label for="amount_paid" class="text-gray-600">Amount Paid</label>
                ...
                <div class="pt-3 flex gap-2">
                    <button type="submit" class="btn btn-primary w-full">Update Sale</button>
                    <a href="{{ route('sales.show', $sale) }}" class="btn btn-secondary w-full">Cancel</a>
                </div>
            </div>
        </div>
    </form>
