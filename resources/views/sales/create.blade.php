            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-sm p-4 space-y-3">
                ...
                <div class="flex justify-between text-sm items-center">
                    ...
                    <input type="number" step="0.01" min="0" id="amount_paid"
                           ...
                           x-model.number="paid" required @input="recalc()">
                </div>
...
function saleForm(){
    return {
        ...
        init(){ this.addLine(); this.recalc(); },
        addLine(){
            this.lines.push({ key: crypto.randomUUID?.() || Date.now()+Math.random(), product_id:'', quantity:1, unit_price:0 });
        },
