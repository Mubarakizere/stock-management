            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="type" class="form-select" required>
                        <option value="credit" @selected(old('type', $transaction->type) == 'credit')>Credit (Money In)</option>
                        <option value="debit" @selected(old('type', $transaction->type) == 'debit')>Debit (Money Out)</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="date" name="transaction_date" value="{{ old('transaction_date', $transaction->transaction_date) }}" class="form-input" required>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="amount" value="{{ old('amount', $transaction->amount) }}" class="form-input" required>
                ...
                <div>
                    ...
                    <input type="text" name="method" value="{{ old('method', $transaction->method) }}" placeholder="Cash, Bank, MoMo..." class="form-input">
